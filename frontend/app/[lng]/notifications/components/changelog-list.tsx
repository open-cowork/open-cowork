...
const MOCK_CHANGELOG: ChangeLogItem[] = [
    {
        ...
        features: [
            {
                title: "Skills Store",
                description: "New skills marketplace to browse and install AI capabilities.",
                type: "feature",
            },
            {
                title: "Task Drag & Drop",
                description: "Improved sidebar task management with drag and drop support.",
                type: "improvement",
            },
        ],
    },
    {
        ...
        features: [
            {
                title: "Dark Mode",
                description: "Full dark mode support for better visual experience at night.",
                type: "feature",
            },
            {
            ...
            {
                title: "Login Bug Fix",
                description: "Fixed an issue where session was not persisting correctly.",
                type: "fix",
            },
        ],
    },
        ...
        features: [
            {
                ...
                description: "Launch of OpenCoWork with core project and task management features.",
                type: "feature",
            },
        ],
    },
                    ...
                    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 rounded-xl border border-border bg-card shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="font-bold text-lg flex items-center gap-2">
                                ...
                                <span className="text-muted-foreground text-sm font-normal">released on {log.date}</span>
                            </h3>
                        </div>
                            ...
                            {log.features.map((feature, i) => (
                                <div key={i} className="flex gap-3">
                                    <div className="mt-1 shrink-0">
                                        {feature.type === "feature" && <Rocket className="size-4 text-blue-500" />}
                                        {feature.type === "improvement" && <Zap className="size-4 text-amber-500" />}
                                        {feature.type === "fix" && <CheckCircle2 className="size-4 text-green-500" />}
                                    </div>
                                    <div>
