import { Chrome, Mail, Calendar, HardDrive, Github, Slack, Database, Command, Search } from "lucide-react";
...
export const MOCK_CONNECTORS: Connector[] = [
    ...
    },
    {
        ...
        type: "app",
        title: "Google Drive",
        description: "快速访问文件、智能搜索内容，并让 OpenCoWork 协助你更高效地管理文档",
    ...
    // SKILLS
    {
        ...
        type: "skill",
        title: "Web Search",
        description: "Perform real-time web searches to retrieve up-to-date information.",
