                    ...
                    <div className="flex-1 overflow-y-auto p-5">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div className="flex-1 min-w-0">
                                {isLoading ? (
                                    ...
                                    <>
                                        <div className="text-base font-medium truncate">{profile?.email}</div>
                                        <div className="text-sm text-muted-foreground truncate">{profile?.id}</div>
                                    </>
                                )}
                            </div>
                            <div className="flex gap-2">
                                <Button variant="outline" size="icon" className="size-8 bg-[#2d2d2d] border-[#333] hover:bg-[#333]">
                        ...
                        <div className="rounded-xl border border-[#333] bg-[#252525] overflow-hidden">
                            <div className="p-4 flex items-center justify-between border-b border-[#333] border-dashed">
                                ...
                                <Button size="sm" className="rounded-full bg-white text-black hover:bg-gray-200 h-7 px-4 text-xs font-bold">
                                    升级
                                </Button>
                            </div>
                ...
                <div className="flex flex-1 min-h-0">
                    ...
                    <div className="flex-1 bg-[#1e1e1e] flex flex-col min-w-0 min-h-0">
                        <div className="flex items-center justify-between p-5 pb-2 shrink-0">
                            <h2 className="text-xl font-semibold">{SIDEBAR_ITEMS.find(i => i.id === activeTab)?.label}</h2>
                        </div>
                        {renderContent()}
                    </div>
                </div>
